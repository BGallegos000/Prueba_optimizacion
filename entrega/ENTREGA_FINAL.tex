...
\subsection{c) Propuesta de mejora factible}

Una mejora simple es mantener T1 en \(D\to1\to3\to D\), corregir las cargas reales requeridas
y cambiar el orden de T2 a \(D\to4\to2\to D\). La propuesta es:
...
\]
La mejora reduce el costo real mínimo desde 21200 a 1200, elimina el shortage y mantiene
factibilidad de capacidad, estabilidad y ventanas de tiempo.
...
obligatorios. La mejora propuesta corrige las cargas, cambia el orden de T2 a \(D\to4\to2\to D\),
mantiene estabilidad en todos los instantes y reduce el costo real mínimo desde 21200 a 1200.
